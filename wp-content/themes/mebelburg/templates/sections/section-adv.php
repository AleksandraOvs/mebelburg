    ...
    <div class="container">
        ...
        <ul class="section-adv__grid">
            ...
            <li class="section-adv__grid__item box2">
                ...
                <div class="section-adv__grid__item__content">
                    <div class="section-adv__grid__item__content__top color-white">
                        <p class="color-white">30 236 м<sup>2</sup></p>
                    </div>
                    <div class="section-adv__grid__item__content__bottom color-white">
                        <p>обширного выбора<br>и вдохновения</p>
                    </div>
                </div>
            </li>
            ...
            <li class="section-adv__grid__item bg-beige" style="background-image:url(<?php echo get_stylesheet_directory_uri() . '/images/adv4.svg' ?>); background-repeat:no-repeat; background-position: center;">
                <div class="section-adv__grid__item__content">
                    <div class="section-adv__grid__item__content__top">
                        <p class="color-white">150+</p>
                    </div>
                    <div class="section-adv__grid__item__content__bottom">
                        <p class="color-white">магазинов<br>и мебельных брендов</p>
                    </div>
                </div>
            </li>
            <li class="section-adv__grid__item" style="background-color: #f7f7f7;">
        ...
        <p class="section-adv__description">
            Точка притяжения для&nbsp;тех, кто находится в&nbsp;поисках интерьерных решений
        </p>
    </div>
</section>