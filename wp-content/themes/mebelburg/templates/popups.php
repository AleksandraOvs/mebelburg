 <?php if ($advices = carbon_get_theme_option('crb_advice_items')) {
    ?>
     <div class="advice-block hidden">
         ...
         <div class="advice-block__inner">
             <div class="advice-block__inner__img">
                 <?php
                 $advice_img = carbon_get_theme_option('crb_advice_image');
                 $advice_image_url = wp_get_attachment_image_url($advice_img, 'full'); ?>
                 <img src="<?php echo $advice_image_url ?>" alt="img">
             </div>
             <?php
             $advices = carbon_get_theme_option('crb_advice_items');
                foreach ($advices as $advice) {
                ?>

                 <div class="advice-block__text">
                     <h4 class="advice-heading">Советы от мишки Мё</h4>
                     <p><?php echo $advice['crb_advice_text'] ?></p>
                 </div>
